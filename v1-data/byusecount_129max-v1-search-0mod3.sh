...
/usr/global/bin/calc -d -p \
   '/* survey */
    ...
    mat x_tbl[x_tbl_len];
    x_tbl = {
	29, 56, 74, 66, 50, 11, 20, 5, 26, 110, 51, 100, 8, 38, 3, 18, 77, 27, 83, 102, 123, 129, 105, 99,
	111, 81, 69, 125, 120, 109, 91, 45, 95, 85, 84, 39, 71, 60, 59, 116, 55, 104, 49, 115, 21, 101, 80,
	76, 41, 36, 35, 31, 64, 15, 90, 124, 65, 61, 24, 114, 44, 40, 19, 54, 121, 88, 92, 9, 86, 43, 127,
	122, 118, 75, 89, 78, 17, 32, 113, 87, 28, 42, 13, 63, 57, 108, 67, 112, 97, 58, 53, 82, 12, 107,
	103, 72, 33, 128, 37, 68, 117, 93
    };
    beyond_v1 = 130;
